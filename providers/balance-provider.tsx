...
export const MidenSdkStoreContext = createContext<Balancestore | undefined>(undefined);
...
export const useObserveBalance = () => {
    ...
    useEffect(() => {
        if (!client || !account) {
            console.warn("Miden SDK client or account address not initialized for balance observation");
            return;
        }
