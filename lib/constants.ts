...
export const ADD_ADDRESS_API = (address: string) => `https://api.midenbrowserwallet.com/add/${address}`;
export const STATS_API = `https://api.midenbrowserwallet.com/stats`;
export const LATEST_TRANSACTIONS_API = `https://api.midenbrowserwallet.com/latest-transactions`;
export const GET_TRANSACTION = (txId: string) => `https://api.midenbrowserwallet.com/transaction/${txId}`;
export const GET_CHART_DATA = `https://api.midenbrowserwallet.com/chart-data`;