const devnet = true; // if deploying in devnet turn to true
export const BASE_API_URL = process.env.NODE_ENV == "development" ? "http://localhost:8000" : (devnet ? "https://devnet-api.midenbrowserwallet.com" : "https://api.midenbrowserwallet.com");
export const MIDEN_WEB_WALLET_LOCAL_STORAGE_KEY = "miden-web-wallet";
export const FAUCET_ID = "0x2b409be7647ca720164e5176a54363"
export const DECIMALS = 1e8
export const RPC_ENDPOINT = process.env.NODE_ENV === "development" ? "https://rpc.devnet.miden.io:443" : (devnet ? "https://rpc.devnet.miden.io:443" : "https://rpc.testnet.miden.io:443");
...
export const TX_PROVER_ENDPOINT = process.env.NODE_ENV === "development" ? "https://tx-prover.devnet.miden.io" : (devnet ? "https://tx-prover.devnet.miden.io" : 'https://tx-prover.testnet.miden.io');
