              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <svg
                    ...
                    onClick={() => window.open(GITHUB_FEEDBACK_URL, "_blank")}
                  >
                    <path
...
function NavDesktopItem({ name, href }: { name: string; href: string }) {
  return (
    <Link
      href={href}
...
function NavMobileItem({ name, href }: { name: string; href: string }) {
  return (
    <Link
      href={href}
