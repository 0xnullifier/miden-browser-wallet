...
import { GET_ADDRESS_TRANSACTIONS, GET_TRANSACTION_COUNT } from "@/lib/constants";
...
export function AddressComponent() {
    ...
    const fetchAddressData = async (pageNum: number) => {
        ...
        setPaginatedTransactions(data.map((tx: any) => ({
            tx_id: tx.tx_id,
            sender: tx.sender,
            tx_kind: tx.tx_kind,
            ...
            <div className="space-y-6 w-full max-w-6xl px-4">
                ...
                <div className="border border-border rounded-lg p-8 text-center">
                    <div className="space-y-3">
                        <div className="text-lg font-medium text-destructive">Something went wrong</div>
                        <div className="text-sm text-muted-foreground">
                            There was an error loading the transactions. Please try again later or reach out for support.
                        </div>
                        <Button
                            variant="outline"
                            onClick={() => {
                ...
                <div className="border border-border rounded-lg p-6 bg-card">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="space-y-2">
                                <div>
                                    <h1 className="text-lg font-semibold text-foreground">Wallet Address</h1>
                                    <div className="font-mono text-sm text-muted-foreground break-all">
                                        {id}
                                    </div>
                                </div>
                ...
                <Table >
                    <TableHeader>
                        <TableRow className="border-border">
                            <TableHead className="text-center text-muted-foreground py-2">HASH</TableHead>
                            <TableHead className="text-center text-muted-foreground py-2">TYPE</TableHead>
                            <TableHead className="text-center text-muted-foreground py-2">BLOCK</TableHead>
                            <TableHead className="text-center text-muted-foreground py-2">TIMESTAMP</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {loading ? (
